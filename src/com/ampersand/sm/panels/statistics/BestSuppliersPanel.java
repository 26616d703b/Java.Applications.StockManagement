...
public class BestSuppliersPanel extends ABasicBestPanel {

	/*
	 * Attributes
	 */
	private static final long serialVersionUID = 1374390421165627971L;
	...
	public BestSuppliersPanel(MySQLDatabase database) {
	...
	private void initBarChart() {
		...
		final ResultSet result_set = m_database.executeSelection("SELECT * FROM Fournisseur");
		...
		try {
			...
			while (result_set.next()) {
				...
				category_dataset.addValue(result_set.getInt("Articles_Vendus"), result_set.getString("Nom"),
						new Integer(i));
		...
		final JFreeChart bar_chart = ChartFactory.createBarChart("Meilleurs fournisseurs", null, "Articles vendus",
